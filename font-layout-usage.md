...
- **通用字体：**
    - 标题缺失字符回退字体 ["FallbackFont"] : "SEGUISYM.TTF"

- **单曲版面**
    - **头版字体**
        - 歌曲标题字体 ["TitleFont"] : "FOT-NewRodinProN-UB.otf"
    ...
    - **单曲信息["maiMusicInfo"]**
        - 各难度定数/Notes数量 ["ConstantFont"] : "RoGSanSrfStd-Bd.otf"
        - 谱师/版本/抽象画作者 ["AuthorFont"] : "江城圆体 700W.ttf"

    - **分数线["maiMusicScoreLine"]**
        - 综合数据 ["ChartDataFont"] : "RoGSanSrfStd-Bd.otf"

- **列表类版面**
    - **Best50[maiPlayerBest50]**
        - _背景板部分_
            - 用户Rating ["RatingFont"] : "江城圆体 600W.ttf"
            - 用户名字体 ["UserNameFont"] : "江城圆体 500W.ttf"
            - B35+B15/推荐歌曲定数/旅行伙伴等级 ["MetaFont"] : "RoGSanSrfStd-Bd.otf"
        - _歌曲卡片部分_
